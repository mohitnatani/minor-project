        ...
        for(let i=0; i<data.length; i++){
            ...
            <div class="col-6 mb-4 listing-property" onclick="goto(${data[i]._id})">
                <div class="row position-relative listing-container">
                    <div class="col-6 p-0">
                        <img src="${data[i].images.picture_url}" class="img-fluid listing-image" />
                    </div>
                    <div class="col-6 pt-3 ps-3">
                        <p>${data[i].name}</p>
                        <p></p>
                        <p><span class="material-symbols-outlined position-relative" style="top:5px">bed</span><span>${data[i].bedrooms} bedrooms</span> <span class="material-symbols-outlined position-relative" style="top:3px">bathtub</span>${data[i].bathrooms["$numberDecimal"]} bathrooms</p>
                        <p class="rental-price">from &dollar;${data[i].price["$numberDecimal"]} / night</p>
                    </div>
                </div>
            </div>`
